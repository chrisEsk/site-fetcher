# IMPORTANT! - I currenly have a specific configuration on my network adapter and installing Docker would cause troubles on my machine. So I add this file explaining what I would do to achieve the local mirror instead.
